...
using Quick_Angular_Application2.Authorization;
using Quick_Angular_Application2.Helpers;
using System;
using System.Collections.Generic;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace Quick_Angular_Application2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /*services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Quick_Angular_Application2")));*/
    ...
    options.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=master;Trusted_Connection=True;"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - Quick_Angular_Application2";
